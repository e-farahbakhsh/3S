...
## References
Farahbakhsh, E., Chandra, R., Eslamkish, T., Muller, R. D., 2019, Modeling geochemical anomalies of stream sediment data through a weighted drainage catchment basin method for prospecting porphyry Cu-Au mineralization, *Journal of Geochemical Exploration* (Accepted for Publication)
